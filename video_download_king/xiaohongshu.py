...
class XiaohongshuService:
    ...
    async def _analyze(
        ...
        # The current desktop page may expose only a watermarked playback stream.
        # Xiaohongshu's mobile page still includes consumer.originVideoKey, which
        # is the original, watermark-free upload.
        headers = {"User-Agent": _MOBILE_USER_AGENT, "Referer": "https://www.xiaohongshu.com/explore"}
